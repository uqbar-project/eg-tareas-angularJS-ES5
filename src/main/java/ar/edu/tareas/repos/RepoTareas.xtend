...
class RepoTareas extends CollectionBasedRepo<Tarea> {
	...
	private new() {
		...
		this.crearTarea('Desarrollar componente de envio de mails', null, new Date(), "Iteración 1", 0)
		this.crearTarea('Implementar single sign on desde la extranet', null, new Date(9, 9, 114), "Iteración 1", 76)
		this.crearTarea('Cancelar pedidos que esten pendientes desde hace 2 meses', null, new Date(3, 2, 115),
			"Iteración 1", 22)
